...
void initStandardActions() {
    ...
    std::vector<DAMAGE_TYPES> blockBuilder;
    ...
    actions.emplace("pass", action("Pass", "Do nothing", moveBuilder, blockBuilder, 0));
    ...
    moveBuilder.emplace_back(-1, 0);
    moveBuilder.emplace_back(0, -1);
    actions.emplace("moveAdj1", action("Sidestep", "Move adjacently", moveBuilder, blockBuilder, 0));
    moveBuilder.clear();
}